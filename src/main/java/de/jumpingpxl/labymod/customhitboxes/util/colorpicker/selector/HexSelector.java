...
public class HexSelector extends ColorSelector {
	...
	public void initTextField() {
		...
		getTextField().func_175205_a(input -> {
	...
	@Override
	public void draw(Tessellator tessellator, WorldRenderer buffer) {
		renderText("Hex");
	}

	@Override
	public void drawMarker(Tessellator tessellator, WorldRenderer buffer) {
	}
	...
	public void renderTextField(Tessellator tessellator, WorldRenderer buffer, int mouseX,
		...
		int minX = getTextField().xPosition - 2;
		int minY = getTextField().yPosition - 2;
